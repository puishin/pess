...
<head>
<meta charset = "utf-8">
<title> Police Emergency Services Systems </title>
...
if(isset($_POST["btnDispatch"]))
{
	...
	$sql = "INSERT INTO incident (caller_name, phone_number, incident_type_id, incident_location, incident_desc, incident_status_id) VALUE ('".$_POST['callerName']."', '".$_POST['contactNo']."', '".$_POST['incidentType']."', '".$_POST['location']."', '".$_POST['incidentDesc']."', $incidentStatus)";
